...
[![Codecov test coverage](https://codecov.io/gh/ropensci-review-tools/pkgcheck/graph/badge.svg)](https://app.codecov.io/gh/ropensci-review-tools/pkgcheck)
...
including `R CMD check` results, a number of statistics via the [`pkgstats`
...
package also uses the [GitHub GraphQL API](https://docs.github.com/v4)
...
re-generating these results each time, `pkgcheck` saves previous reports to
...
handle is itself an [`R6` object](https://r6.r-lib.org/) with a number of
...
## See Also
[The `checklist` package](https://github.com/inbo/checklist) for "checking R
packages and R code".
